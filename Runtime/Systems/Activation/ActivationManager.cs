...
namespace Lost
{
    ...
    public sealed class ActivationManager : SingletonMonoBehaviour<ActivationManager>, IName, ILevelLoadPreprocessor
    {
        ...
        public string Name => "Activation Manager";
        ...
        {
            isProcessing = true;
            Instance.monoBehaviours.Enqueue(monoBehaviour);
        }
